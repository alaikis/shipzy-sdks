...
public class OrderClient {
    ...
    public OrderClient(ZymeupClient client) {
        this.client = client;
    }

    public Map<String, Object> list(int page, int pageSize, String status) throws Exception {
        StringBuilder path = new StringBuilder("/api/v1/order/list?page=").append(page).append("&page_size=").append(pageSize);
    ...
    public Map<String, Object> get(String id) throws Exception {
        HttpRequest request = client.newRequest("/api/v1/order/" + id).GET().build();
        HttpResponse<String> response = client.send(request);
        return parseResponse(response.body());
    }

    public Map<String, Object> create(Map<String, Object> data) throws Exception {
        HttpRequest request = client.newRequest("/api/v1/order/create")
    ...
    public Map<String, Object> update(String id, Map<String, Object> data) throws Exception {
        HttpRequest request = client.newRequest("/api/v1/order/" + id + "/update")
                .POST(HttpRequest.BodyPublishers.ofString(toJson(data)))
                .build();
        HttpResponse<String> response = client.send(request);
        return parseResponse(response.body());
    ...
    public Map<String, Object> cancel(String id) throws Exception {
        HttpRequest request = client.newRequest("/api/v1/order/" + id + "/cancel")
